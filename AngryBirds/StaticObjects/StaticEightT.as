package StaticObjects 
{
	 ...
	 * @author ...
	 */
	public class StaticEightT extends StaticObject 
	{
		public function StaticEightT(po:Point) 
		{
			super(po);
		}
		override public function setAngryBody():void
		{
			...
			this.AngryBoxDef.vertices[0].Set(230/30, -120 / 30);
			//this.AngryBoxDef.vertices[1].Set( 230 / 30, -78 / 30);
			//this.AngryBoxDef.vertices[2].Set( 180 / 30, -25 / 30);
			//this.AngryBoxDef.vertices[3].Set( 230 / 30, 25 / 30);
			this.AngryBoxDef.vertices[1].Set( 230 / 30, 120 / 30);
			//this.AngryBoxDef.vertices[2].Set( -230 / 30, 60 / 30);
			//this.AngryBoxDef.vertices[3].Set( -158 / 30, -15 / 30);
			this.AngryBoxDef.vertices[2].Set( 70 / 30, 45 / 30);
			
			var AnotherBoxDef:b2PolygonDef = new b2PolygonDef();
			AnotherBoxDef.vertexCount = 4;
			AnotherBoxDef.vertices[0].Set( 230 / 30, 120 / 30);
			AnotherBoxDef.vertices[1].Set( -230 / 30, 120 / 30);
			AnotherBoxDef.vertices[2].Set( -158 / 30, 45 / 30);
			AnotherBoxDef.vertices[3].Set( 70 / 30, 45 / 30);
